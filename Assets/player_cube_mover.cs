...
public class player_cube_mover_ : MonoBehaviour {
   ...
   public  bool is_r_right = false;
    ...
    void Start () {
        ...
        {
            min_port_distance_to_player = this.transform.localScale.x / 2 ;
        }
	}
 ...
 is_l_right = false;
    ...
    RaycastHit hit_r;
        ...
        Debug.DrawLine(this.transform.position, hit_r.point, Color.cyan);
       ...
       // Debug.Log("R  : " + hit_r.distance + "   is_right  :  " + is_r_right);
        ...
        Debug.DrawLine(this.transform.position, hit_l.point, Color.blue);
        if (hit_l.distance <= min)
            {
              //is_l_right = true;
                Debug.DrawLine(this.transform.position,hit_l.point, Color.red);
                foreach (string tag in to_switch_tags) //the line the error is pointing to
                {
                      ...
                      Debug.Log("packmoder -> clicked");
                        if (is_l_right)
                        {
                            ...
                            if(hit_l.distance * 2 < min_port_distance_to_player){
                                ...
                                new_port_distance =  hit_l.distance * 2;}
